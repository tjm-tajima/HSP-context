...
| 命令 | 概要 |
|---|---|
| [bcopy](#bcopy) | ファイルのコピー |
| [chdir](#chdir) | ディレクトリ移動 |
| [delete](#delete) | ファイル削除 |
| [dirlist](#dirlist) | ディレクトリ一覧を取得 |
| [exist](#exist) | ファイルのサイズ取得 |
| [mkdir](#mkdir) | ディレクトリ作成 |
| [bload](#bload) | バッファにファイルをロード |
| [bsave](#bsave) | バッファをファイルにセーブ |
| [memfile](#memfile) | メモリストリーム設定 |
| [chdpm](#chdpm) | DPMファイル設定 |
...
**関連**: noteload, bcopy, bsave, %port+, Let
