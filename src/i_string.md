...
| 命令 | 概要 |
|---|---|
| [getstr](#getstr) | バッファから文字列読み出し |
| [noteadd](#noteadd) | 指定行の追加・変更 |
| [notedel](#notedel) | 行の削除 |
| [noteget](#noteget) | 指定行を読み込み |
| [noteinfo](#noteinfo) | メモリノートパッド情報取得 |
| [notesel](#notesel) | 対象バッファ指定 |
| [noteunsel](#noteunsel) | 対象バッファの復帰 |
| [strmid](#strmid) | 文字列の一部を取り出す |
| [instr](#instr) | 文字列の検索をする |
| [notesave](#notesave) | 対象バッファ保存 |
| [noteload](#noteload) | 対象バッファ読み込み |
| [getpath](#getpath) | パスの一部を取得 |
| [strf](#strf) | 書式付き文字列を変換 |
| [cnvwtos](#cnvwtos) | unicodeを通常文字列に変換 |
| [cnvstow](#cnvstow) | 通常文字列をunicodeに変換 |
| [strtrim](#strtrim) | 指定した文字だけを取り除く |
| [split](#split) | 文字列から分割された要素を代入 |
| [strrep](#strrep) | 文字列の置換をする |
| [notefind](#notefind) | メモリノートパッド検索 |
| [cnvatos](#cnvatos) | ANSI文字列を通常文字列に変換 |
| [cnvstoa](#cnvstoa) | 通常文字列をANSI文字列に変換 |
| [strexchange](#strexchange) | スクリプト内の文字列を置き換える |
...
**関連**: notesel, noteget, notedel, notemax, notesize
...
**関連**: noteunsel, noteget, noteadd, notedel, noteinfo, notemax, notesize, notefind
...
**関連**: notesel, noteload, noteget, noteadd, notedel, noteinfo, %port-, Let
...
**関連**: notesel, notesave, noteget, noteadd, notedel, noteinfo, notemax, notesize, notefind
...
**関連**: cnvstow, cnvstoa, cnvatos, str, %port-, Let
...
**関連**: cnvwtos, cnvstoa, cnvatos, str, %port-, Let
...
**関連**: cnvstow, cnvwtos, cnvstoa, str, %port-, Let

**備考**: hsp3utf.asをインクルードすること。
...
**関連**: cnvstow, cnvwtos, cnvatos, str, %port-, Let
