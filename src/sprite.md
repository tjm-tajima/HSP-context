...
| 命令 | 概要 |
|---|---|
| [es_ini](#es_ini) | システムの初期化 |
| [es_area](#es_area) | スプライト有効エリア設定 |
| [es_size](#es_size) | キャラクタサイズ指定 |
| [es_pat](#es_pat) | キャラクタ画像定義 |
| [es_link](#es_link) | アニメーション設定 |
| [es_kill](#es_kill) | スプライト削除 |
| [es_clear](#es_clear) | 複数スプライト削除 |
| [es_exnew](#es_exnew) | 新規スプライト取得 |
| [es_new](#es_new) | 新規スプライト取得 |
| [es_get](#es_get) | スプライト情報取得 |
| [es_setp](#es_setp) | スプライトパラメータ設定 |
| [es_find](#es_find) | スプライト検索 |
| [es_check](#es_check) | 衝突判定取得 |
| [es_offset](#es_offset) | オフセット座標設定 |
| [es_set](#es_set) | スプライト設定 |
| [es_flag](#es_flag) | flag値設定 |
| [es_chr](#es_chr) | chr値設定 |
| [es_type](#es_type) | type値設定 |
| [es_pos](#es_pos) | スプライト座標設定 |
| [es_setrot](#es_setrot) | スプライト回転角度・表示倍率設定 |
| [es_apos](#es_apos) | スプライト移動設定 |
| [es_setgosub](#es_setgosub) | スプライト表示コールバック設定 |
| [es_adir](#es_adir) | スプライト移動方向設定 |
| [es_aim](#es_aim) | スプライト参照座標設定 |
| [es_draw](#es_draw) | スプライト描画 |
| [es_gravity](#es_gravity) | 落下加速度設定 |
| [es_bound](#es_bound) | 弾みやすさ設定 |
| [es_effect](#es_effect) | スプライト特殊効果設定 |
| [es_fade](#es_fade) | スプライト点滅・フェード設定 |
| [es_move](#es_move) | スプライト移動 |
| [es_setpri](#es_setpri) | スプライト優先順位設定 |
| [es_put](#es_put) | キャラクタ画面表示 |
| [es_ang](#es_ang) | 角度取得 |
| [es_cos](#es_cos) | 三角関数 |
| [es_sin](#es_sin) | 三角関数 |
| [es_dist](#es_dist) | 2点間距離算出 |
| [es_bye](#es_bye) | スプライトシステム解放 |
| [es_opt](#es_opt) | スプライト反発座標の設定 |
| [es_patanim](#es_patanim) | まとめてキャラクタ画像定義 |
| [es_getpos](#es_getpos) | スプライト座標取得 |
| [es_bgmap](#es_bgmap) | BGマップを初期化 |
| [es_putbg](#es_putbg) | BGマップを表示 |
| [es_bgmes](#es_bgmes) | BGマップに文字列を書き込み |
| [es_setparent](#es_setparent) | スプライトの親設定 |
| [es_modaxis](#es_modaxis) | スプライト情報をまとめて変更 |
| [es_arot](#es_arot) | スプライト自動回転ズーム設定 |
...
**関連**: es_set, es_setpri, es_setgosub
...
**関連**: es_putbg, dim, celload, celdiv
