...
|---|---|
| [mci](#mci) | MCIにコマンドを送る |
| [mmplay](#mmplay) | メディア再生 |
| [mmload](#mmload) | メディアファイル読み込み |
| [mmstop](#mmstop) | メディア再生の停止 |
| [mmvol](#mmvol) | 音量の設定 |
| [mmpan](#mmpan) | パンニングの設定 |
| [mmstat](#mmstat) | メディアの状態取得 |
...
**動作条件**: HSPLet時、WAV/AIFF/AU/MIDI/MP3 をサポートしています。 MP3の再生には付属の jl1.0.jar が必要です。
