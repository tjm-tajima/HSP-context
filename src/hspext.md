...
| 命令 | 概要 |
|---|---|
| [aplsel](#aplsel) | 任意のウィンドウ捕獲 |
| [aplobj](#aplobj) | 任意のオブジェクト捕獲 |
| [aplact](#aplact) | ウィンドウをアクティブにする |
| [aplfocus](#aplfocus) | キー送信先をデフォルトにする |
| [aplstr](#aplstr) | 文字列をキー送信 |
| [aplkey](#aplkey) | キーコード送信 |
| [aplkeyd](#aplkeyd) | キー押し下げ送信 |
| [aplkeyu](#aplkeyu) | キー押し上げ送信 |
| [aplget](#aplget) | オブジェクトの文字列を取得 |
| [apledit](#apledit) | エディットコントロール情報取得 |
| [clipset](#clipset) | クリップボードテキスト転送 |
| [clipsetg](#clipsetg) | クリップボード画像転送 |
| [clipget](#clipget) | クリップボードテキスト取得 |
| [comopen](#comopen) | シリアルポートを初期化 |
| [comclose](#comclose) | シリアルポートを解放 |
| [comput](#comput) | シリアルポートに送信 |
| [computc](#computc) | シリアルポートに送信 |
| [computb](#computb) | シリアルポートにバイナリ送信 |
| [comgetc](#comgetc) | シリアルポートから受信 |
| [comget](#comget) | シリアルポートから文字列を受信 |
| [comcontrol](#comcontrol) | シリアルポートの特殊コントロール |
| [comstat](#comstat) | シリアルポートの状態取得 |
| [gfini](#gfini) | 対象画面を設定 |
| [gfcopy](#gfcopy) | 半透明コピー |
| [gfdec](#gfdec) | 画面の色減算 |
| [gfinc](#gfinc) | 画面の色加算 |
| [fxcopy](#fxcopy) | ファイルのコピー・移動 |
| [fxren](#fxren) | ファイル名を変更 |
| [fxinfo](#fxinfo) | ドライブ情報を取得 |
| [fxaget](#fxaget) | ファイル属性を取得 |
| [fxaset](#fxaset) | ファイル属性を設定 |
| [fxtget](#fxtget) | タイムスタンプを取得 |
| [fxtset](#fxtset) | タイムスタンプを設定 |
| [selfolder](#selfolder) | フォルダ選択ダイアログ |
| [fxshort](#fxshort) | DOSファイルネームを取得 |
| [fxdir](#fxdir) | 特殊なディレクトリ名を取得 |
| [fxlink](#fxlink) | ショートカットを作成 |
| [lzdist](#lzdist) | 圧縮解凍先ディレクトリ指定 |
| [lzcopy](#lzcopy) | 圧縮解凍コピー |
| [emath](#emath) | 固定小数の精度を指定 |
| [emstr](#emstr) | 固定小数を文字列に変換 |
| [emcnv](#emcnv) | 文字列を固定小数に変換 |
| [emint](#emint) | 固定小数を整数に変換 |
| [emsin](#emsin) | サインを求める |
| [emcos](#emcos) | コサインを求める |
| [emsqr](#emsqr) | 平方根を求める |
| [ematan](#ematan) | アークタンジェントを求める |
| [regkey](#regkey) | レジストリキー指定 |
| [getreg](#getreg) | レジストリ読み出し |
| [setreg](#setreg) | レジストリ書き込み |
| [regkill](#regkill) | レジストリキー削除 |
| [reglist](#reglist) | レジストリ一覧取得 |
| [sysexit](#sysexit) | システムに終了を通知 |
| [pipeexec](#pipeexec) | パイプ付き実行 |
| [pipeget](#pipeget) | パイプ付き実行監視 |
| [pipeput](#pipeput) | パイプに1byte送る |
| [dirlist2](#dirlist2) | 拡張ディレクトリ取得 |
| [dirlist2h](#dirlist2h) | 拡張ディレクトリ取得設定 |
| [dirlist2r](#dirlist2r) | 拡張ディレクトリ取得2 |
...
**関連**: aplobj, aplact, aplfocus, aplstr, aplkey, aplkeyd, aplkeyu, aplget, apledit
...
**関連**: aplsel, aplact, aplfocus, aplstr, aplkey, aplkeyd, aplkeyu, aplget, apledit
...
**関連**: aplsel, aplobj, aplfocus, aplstr, aplkey, aplkeyd, aplkeyu, aplget, apledit
...
**関連**: aplsel, aplobj, aplact, aplstr, aplkey, aplkeyd, aplkeyu, aplget, apledit
...
**関連**: aplsel, aplobj, aplact, aplfocus, aplkey, aplkeyd, aplkeyu, aplget, apledit
...
**関連**: aplsel, aplobj, aplact, aplfocus, aplstr, aplkeyd, aplkeyu, aplget, apledit
...
**関連**: aplsel, aplobj, aplact, aplfocus, aplstr, aplkey, aplkeyu, aplget, apledit
...
**関連**: aplsel, aplobj, aplact, aplfocus, aplstr, aplkey, aplkeyd, aplget, apledit
...
**関連**: aplsel, aplobj, aplact, aplfocus, aplstr, aplkey, aplkeyd, aplkeyu, apledit
...
**関連**: aplsel, aplobj, aplact, aplfocus, aplstr, aplkey, aplkeyd, aplkeyu, aplget
...
**関連**: comclose, comput, comget, computc, computb, comgetc, comstat, comcontrol
...
**関連**: comopen, comclose, computc, computb
...
**関連**: comopen, comclose, comput, computb
...
**関連**: comopen, comclose, comput, computc
