...
- **対応環境**: Win
- **動作条件**: Windows+DirectX8以降のシステム上でのみ動作します。
...
| 命令 | 概要 |
|---|---|
| [hgini](#hgini) | プラグインの初期化 |
| [hgreset](#hgreset) | シーン情報の初期化 |
| [hgbye](#hgbye) | プラグインの解放 |
| [hgdraw](#hgdraw) | 描画の実行 |
| [hgsync](#hgsync) | 時間待ちを行なう |
| [hgsetreq](#hgsetreq) | システムリクエスト設定 |
| [hggetreq](#hggetreq) | システムリクエスト取得 |
| [hgrect](#hgrect) | 矩形の直接描画 |
| [hgrotate](#hgrotate) | 矩形画像の直接描画 |
| [hgline](#hgline) | 直線の直接描画 |
| [settex](#settex) | テクスチャを登録 |
| [texload](#texload) | テクスチャをファイルから登録 |
| [texload2](#texload2) | テクスチャをファイルから登録 |
| [loadtoon](#loadtoon) | トゥーンテクスチャをファイルから登録 |
| [maketoon](#maketoon) | トゥーンテクスチャを作成 |
| [setfont](#setfont) | オリジナルフォント定義 |
| [fprt](#fprt) | 定義フォント文字列表示 |
| [falpha](#falpha) | フォント文字α値を設定 |
| [setsizef](#setsizef) | 登録モデルの幅、高さを指定 |
| [clscolor](#clscolor) | 背景色設定 |
| [clstex](#clstex) | 背景テクスチャ設定 |
| [clsblur](#clsblur) | ブラー設定 |
| [texmake](#texmake) | メッセージテクスチャの作成 |
| [texcls](#texcls) | メッセージテクスチャのクリア |
| [texmes](#texmes) | メッセージテクスチャへの描画 |
| [texdel](#texdel) | テクスチャの削除 |
| [setuv](#setuv) | 登録テクスチャUV座標を指定 |
| [addspr](#addspr) | 2Dスプライトモデルを作成 |
| [regobj](#regobj) | オブジェクトの登録 |
| [addplate](#addplate) | 板(PLATE)モデルを作成 |
| [addsplate](#addsplate) | 板(SPLATE)モデルを作成 |
| [setcolor(HGIMG3)](#setcolorhgimg3) | 単色ポリゴン作成設定 |
| [addbox](#addbox) | 箱(BOX)モデルを作成 |
| [addmesh](#addmesh) | 板(MESH)モデルを作成 |
| [addeprim](#addeprim) | エフェクト(EPRIM)モデルを作成 |
| [seteprim](#seteprim) | エフェクト(EPRIM)モデルを設定 |
| [setefx](#setefx) | efxグループ情報を設定 |
| [addefx](#addefx) | efxグループ情報を加算 |
| [getefx](#getefx) | efxグループ情報を取得 |
| [getangi](#getangi) | angグループ情報を整数で取得 |
| [getefxi](#getefxi) | efxグループ情報を整数で取得 |
| [selefx](#selefx) | オブジェクト特殊効果をMOC情報に設定 |
| [objset1](#objset1) | MOC情報を設定 |
| [objsetf1](#objsetf1) | MOC情報を設定 |
| [objadd1](#objadd1) | MOC情報を加算 |
| [objadd1r](#objadd1r) | MOC情報を加算 |
| [objaddf1](#objaddf1) | MOC情報を加算 |
| [objset1r](#objset1r) | MOC情報を設定 |
| [objset2](#objset2) | MOC情報を設定 |
| [objsetf2](#objsetf2) | MOC情報を設定 |
| [objadd2](#objadd2) | MOC情報を加算 |
| [objaddf2](#objaddf2) | MOC情報を加算 |
| [objadd2r](#objadd2r) | MOC情報を加算 |
| [objset2r](#objset2r) | MOC情報を設定 |
| [dxfload](#dxfload) | DXF形式ファイルを読み込み |
| [adddxf](#adddxf) | DXF形式データの登録 |
| [modelscale](#modelscale) | モデルのサイズを変更する |
| [cammode](#cammode) | カメラモードの設定 |
| [settoonedge](#settoonedge) | トゥーンシェーディング時の設定 |
| [event_addefx](#event_addefx) | efxグループ加算イベントを追加 |
| [event_efx](#event_efx) | efxグループ変化イベントを追加 |
| [event_setefx](#event_setefx) | efxグループ設定イベントを追加 |
| [event_uv](#event_uv) | UV設定イベントを追加 |
| [setobjmodel](#setobjmodel) | オブジェクトのモデル設定 |
| [event_wpos](#event_wpos) | posグループ変化イベントを追加 |
| [event_wang](#event_wang) | angグループ変化イベントを追加 |
| [event_wscale](#event_wscale) | scaleグループ変化イベントを追加 |
| [event_wdir](#event_wdir) | dirグループ変化イベントを追加 |
| [event_wefx](#event_wefx) | efxグループ変化イベントを追加 |
| [event_regobj](#event_regobj) | オブジェクト生成イベントを追加 |
| [event_eprim](#event_eprim) | エフェクト設定イベントを追加 |
| [selcam](#selcam) | カメラをMOC情報に設定 |
| [sellight](#sellight) | 光源をMOC情報に設定 |
| [selcpos](#selcpos) | カメラ座標をMOC情報に設定 |
| [selcang](#selcang) | カメラ角度をMOC情報に設定 |
| [selcint](#selcint) | カメラ注視点をMOC情報に設定 |
| [sellpos](#sellpos) | 光源座標をMOC情報に設定 |
| [sellang](#sellang) | 光源角度をMOC情報に設定 |
| [sellcolor](#sellcolor) | 光源色をMOC情報に設定 |
| [sellambient](#sellambient) | 環境光色をMOC情報に設定 |
| [objgetv](#objgetv) | MOC情報を整数値で取得 |
| [objsetv](#objsetv) | MOC情報を整数値で設定 |
| [objgetstr](#objgetstr) | MOC情報を文字列で取得 |
| [objact](#objact) | 指定アニメーションを開始 |
| [getanim](#getanim) | アニメーション情報を取得 |
| [addxfile](#addxfile) | Xファイルモデルを作成 |
| [addxanim](#addxanim) | Xファイルアニメーションの追加 |
| [objspeed](#objspeed) | アニメーション再生速度の設定 |
| [modelspeed](#modelspeed) | アニメーション再生速度の設定(2) |
| [hgcapture](#hgcapture) | DirectX画面データの取得 |
| [objlight](#objlight) | 参照されるライトの設定 |
| [reglight](#reglight) | ライトオブジェクトの登録 |
| [getxinfo](#getxinfo) | Xモデル表示情報の取得 |
| [setxinfo](#setxinfo) | Xモデル情報の詳細設定 |
| [getobjmodel](#getobjmodel) | オブジェクトのモデルID取得 |
| [modelcols](#modelcols) | コリジョンパラメーターの設定(2) |
| [setcolscale](#setcolscale) | コリジョンパラメーターの設定 |
| [modelshade](#modelshade) | シェーディングモードの設定 |
| [modelorder](#modelorder) | 回転順序モードの設定 |
| [objchild](#objchild) | オブジェクトの親子関係設定 |
| [objproj](#objproj) | オブジェクトのプロジェクション変更 |
| [dmmini](#dmmini) | サウンド機能初期化 |
| [dmmreset](#dmmreset) | サウンド機能の設定をリセット |
| [dmmbye](#dmmbye) | サウンド機能終了処理 |
| [dmmdel](#dmmdel) | サウンドデータを削除 |
| [dmmvol](#dmmvol) | サウンドデータの音量設定 |
| [dmmpan](#dmmpan) | サウンドデータのパン設定 |
| [dmmloop](#dmmloop) | サウンドデータのループ設定 |
| [dmmload](#dmmload) | サウンドデータの読み込み |
| [dmmplay](#dmmplay) | サウンドデータの再生 |
| [dmmstop](#dmmstop) | サウンドデータの再生停止 |
| [dmmstat](#dmmstat) | サウンドデータの状態取得 |
| [hgprm](#hgprm) | 動作パラメーターの設定 |
| [objaim](#objaim) | オブジェクトを目標に向けて操作する |
| [event_aim](#event_aim) | オブジェクト操作イベントを追加 |
| [event_objact](#event_objact) | アニメーション設定イベントを追加 |
| [hgview](#hgview) | 描画エリアの設定 |
| [texopt](#texopt) | 文字列描画モードを設定 |
| [hgsettime](#hgsettime) | リアルタイムタイマー設定 |
| [hggettime](#hggettime) | リアルタイムタイマー取得 |
| [meshmap](#meshmap) | メッシュマップ情報の更新 |
| [getvarmap](#getvarmap) | メッシュマップ情報の作成 |
| [objwalk](#objwalk) | メッシュマップ上の移動 |
| [objfloor](#objfloor) | 地面からの表示オフセット設定 |
| [getcolvec](#getcolvec) | コリジョン情報の取得 |
| [getnearobj](#getnearobj) | 最も近くにあるオブジェクトを検索 |
| [wave_init](#wave_init) | 波紋の初期化 |
| [wave_set](#wave_set) | 波紋の高さを設定 |
| [wave_apply](#wave_apply) | 波紋の状態を取得 |
| [delmodel](#delmodel) | モデルの削除 |
| [hgcnvaxis](#hgcnvaxis) | 3D座標の変換を行なう |
| [hgobaq](#hgobaq) | HGIMG3でのOBAQ初期化 |
| [hgceldiv](#hgceldiv) | HGIMG3でのセル分割指定 |
| [addobaq3d](#addobaq3d) | OBAQ3Dモデルを作成 |
| [addline](#addline) | 線分モデルを作成 |
| [newemit](#newemit) | エミッターを作成 |
| [delemit](#delemit) | エミッターを削除 |
| [emit_size](#emit_size) | エミッターの発生範囲を設定 |
| [emit_speed](#emit_speed) | エミッターのスピード設定 |
| [emit_angmul](#emit_angmul) | エミッターの角度係数を設定 |
| [emit_angopt](#emit_angopt) | エミッターの角度加算値を設定 |
| [emit_model](#emit_model) | エミッターの発生モデルを設定 |
| [emit_event](#emit_event) | エミッターのイベント設定 |
| [emit_num](#emit_num) | エミッターの発生数設定 |
| [emit_group](#emit_group) | エミッターのグループ設定 |
| [hgemit](#hgemit) | エミッター発生実行 |
| [setobjemit](#setobjemit) | オブジェクトにエミッター適用 |
| [groupmod](#groupmod) | 同一グループに演算適用 |
| [hgqview](#hgqview) | HGIMG3上のOBAQビュー設定 |
| [hgqcnvaxis](#hgqcnvaxis) | OBAQ座標をHGIMG3座標に変換 |
| [enumobj](#enumobj) | オブジェクトの検索開始 |
| [getenum](#getenum) | オブジェクトの検索結果を取得 |
...
**関連**: addspr, addplate, addsplate, addbox
...
**関連**: color, font, texmake, texcls, texopt
...
**関連**: addsplate, setcolor(HGIMG3), setsizef, setuv
...
**関連**: addplate, setcolor(HGIMG3), setsizef
...
**関連**: setsizef, setcolor(HGIMG3), setuv
...
**関連**: setsizef, setuv, meshmap, objwalk
...
**関連**: setpos, setang, setangr, setscale, setdir, setwork
...
**関連**: addpos, addang, addangr, addscale, adddir, addwork
...
**関連**: getefxi, getpos, getang, getangr, getscale, getdir, getwork
...
**関連**: getang, getposi, getangri, getscalei, getdiri, getefxi, getworki
...
**関連**: getefx, getposi, getangi, getangri, getscalei, getdiri, getworki
...
**関連**: selmoc, selpos, selang, selscale, selcam, selcpos, selcang, selcint
...
**関連**: objset1, objadd1, objset1r, objsetf1, objaddf1
...
**関連**: objset1, objadd1r, objset1r, objsetf1, objaddf1
...
**関連**: objset2, objadd2, objset2r, objsetf2, objaddf2
...
**関連**: objset2, objadd2r, objset2r, objsetf2, objaddf2
...
**関連**: event_addpos, event_addang, event_addangr, event_addscale, event_adddir, event_addwork, newevent, setevent
...
**構文**
```
event_efx id,frame,x1,y1,z1,sw
```
...
**関連**: event_pos, event_ang, event_angr, event_scale, event_dir, event_work, newevent, setevent
...
**構文**
```
event_setefx id,x1,y1,z1,x2,y2,z2
```
...
**関連**: event_setpos, event_setang, event_setangr, event_setscale, event_setdir, event_setwork, newevent, setevent
...
**関連**: event_wang, event_wangr, event_wscale, event_wdir, event_wefx, newevent, setevent
...
**関連**: event_wpos, event_wangr, event_wscale, event_wdir, event_wefx, newevent, setevent
...
**関連**: event_wpos, event_wang, event_wangr, event_wdir, event_wefx, newevent, setevent
...
**関連**: event_wpos, event_wang, event_wangr, event_wscale, event_wefx, newevent, setevent
...
**関連**: event_wpos, event_wang, event_wangr, event_wscale, event_wdir, newevent, setevent
...
**関連**: event_delobj, newevent, setevent
...
**関連**: addeprim, seteprim, newevent, setevent
...
**関連**: selmoc, selpos, selang, selscale, seldir, selcpos, selcang, selcint
...
**関連**: sellpos, sellang, sellcolor, selmoc, selcam
...
**関連**: selmoc, selpos, selang, selscale, seldir, selcam, selcang, selcint
...
**関連**: cammode, selmoc, selpos, selang, selscale, seldir, selcam, selcpos, selcint
...
**関連**: cammode, selmoc, selpos, selang, selscale, seldir, selcam, selcpos, selcang
...
**関連**: sellight, sellang, sellcolor, sellambient
...
**関連**: sellight, sellpos, sellcolor, sellambient
...
**関連**: sellight, sellpos, sellang, sellambient
...
**関連**: sellight, sellpos, sellang, sellcolor
...
**関連**: objsetv, objsetfv, objgetfv, fvset, fvadd, fvsub, fvmul, fvdiv
...
**関連**: objgetv, objsetfv, objgetfv, fvset, fvadd, fvsub, fvmul, fvdiv
...
**関連**: addxfile, addxanim, objspeed, modelspeed, getanim
...
**関連**: dmmstop, dmmvol, dmmpan, dmmloop, dmmload
...
**構文**
```
event_objact id,Anim,mode,speed
```
...
**関連**: objact, objspeed, newevent, setevent
...
**関連**: addmesh, meshmap, objfloor, getcolvec
...
**関連**: modelcols, setcolscale, objwalk
...
**関連**: addbox, addeprim, addmesh, addplate, addsplate, addspr, addxfile
...
**構文**
```
emit_group id,mygroup,enegroup
```
