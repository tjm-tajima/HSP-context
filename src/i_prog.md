...
| 命令 | 概要 |
|---|---|
| [await](#await) | 一定の時間で待つ |
| [exec](#exec) | Windowsのファイルを実行する |
| [end](#end) | プログラム終了 |
| [gosub](#gosub) | 指定ラベルにサブルーチンジャンプ |
| [goto](#goto) | 指定ラベルにジャンプ |
| [if](#if) | 条件を満たしていればその行の命令を実行 |
| [loop](#loop) | ループの始まりに戻る |
| [onexit](#onexit) | 終了時にジャンプ |
| [return](#return) | サブルーチンから復帰 |
| [run](#run) | 指定したファイルに制御を移す |
| [stop](#stop) | プログラム中断 |
| [wait](#wait) | 実行を一定時間中断する |
| [repeat](#repeat) | ループの始まりの場所を示す |
| [break](#break) | ループから抜ける |
| [continue](#continue) | ループをやり直す |
| [onkey](#onkey) | キー割り込み実行指定 |
| [onclick](#onclick) | クリック割り込み実行指定 |
| [onerror](#onerror) | エラー発生時にジャンプ |
| [exgoto](#exgoto) | 指定ラベルに条件ジャンプ |
| [on](#on) | 数値による分岐 |
| [while](#while) | while繰り返し開始 |
| [wend](#wend) | while繰り返し終了 |
| [until](#until) | do繰り返し終了 |
| [do](#do) | do繰り返し開始 |
| [for](#for) | 指定回数繰り返し開始 |
| [next](#next) | 指定回数繰り返し終了 |
| [switch](#switch) | 比較ブロック開始 |
| [swend](#swend) | 比較ブロック終了 |
| [default](#default) | デフォルト比較指定 |
| [case](#case) | 比較値指定 |
| [swbreak](#swbreak) | 比較実行脱出指定 |
| [_continue](#_continue) | マクロループをやり直す |
| [_break](#_break) | マクロループを脱出する |
| [foreach](#foreach) | 変数の要素数だけ繰り返す |
| [oncmd](#oncmd) | Windowsメッセージ割り込み実行指定 |
| [else](#else) | 条件を満たしていなければその行の命令を実行 |
...
**動作条件**: HSPLet時は、HTML ページを表示する目的で使用されます。
...
**関連**: onkey, onclick, onerror, %port-, Let
...
**関連**: gosub, #deffunc, #defcfunc, stat, refstr, refdval
...
**関連**: loop, break, continue, foreach
...
**関連**: repeat, loop, continue, foreach
...
**関連**: _continue, _break, next, exgoto
...
**関連**: switch, case, default, swbreak
...
**関連**: switch, default, swbreak, swend
...
**関連**: _break, while, wend, do, until, for, next
...
**関連**: _continue, while, wend, do, until, for, next
...
**関連**: onkey, onclick, onexit, onerror
