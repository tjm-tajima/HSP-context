...
| 命令 | 概要 |
|---|---|
| [setreq](#setreq) | システムリクエスト設定 |
| [getreq](#getreq) | システムリクエスト取得 |
| [gfilter](#gfilter) | テクスチャ補間の設定 |
| [mtlist](#mtlist) | ポイントIDリスト取得 |
| [mtinfo](#mtinfo) | タッチ情報取得 |
| [devinfo](#devinfo) | デバイス情報文字列取得 |
| [devinfoi](#devinfoi) | デバイス情報値取得 |
| [devprm](#devprm) | デバイス制御用のパラメーター設定 |
| [devcontrol](#devcontrol) | デバイス制御を実行する |
| [setcls](#setcls) | 画面クリア設定 |
| [celputm](#celputm) | 複数のセルをまとめて描画 |
| [httpload](#httpload) | http通信の開始 |
| [httpinfo](#httpinfo) | http通信の情報を取得 |
| [gmulcolor](#gmulcolor) | テクスチャ乗算値の設定 |
| [viewcalc](#viewcalc) | 描画時の座標変換を設定 |
| [celbitmap](#celbitmap) | 変数バッファを画像データとして適用する |
...
**関連**: gcopy, grotate, gsquare, celput
...
**関連**: color, gcopy, gzoom, grotate, gsquare, celput
