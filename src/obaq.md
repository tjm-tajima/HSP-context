...
**関連**: qview, qexec, qcnvaxis, qgetaxis
...
**構文**
```
qgroup num,mygroup,exgroup,loggroup
```
...
**関連**: qgroup, qgetcol, qgetcol2, qgetcol3
...
**構文**
```
qgetstat num,var_stat,var_sleepcount
```
...
**構文**
```
qgetspeed num,var_px,var_py,var_pr
```
...
**構文**
```
qgetweight num,var_weight,var_moment
```
...
**構文**
```
qgetdamper num,var_damper,var_friction
```
...
**構文**
```
qgetinertia num,var_inertia,var_gravity
```
...
**構文**
```
qgetgroup num,var_mygroup,var_exgroup,var_loggroup
```
...
**構文**
```
qgetmat num,var_type,var_id,var_subid
```
...
**構文**
```
qgetmat2 num,var_offsetx,var_offsety,var_zoomx,var_zoomy
```
...
**構文**
```
qgetmat3 num,var_gmode,var_rate
```
...
**構文**
```
qgetuser num,var_user1,var_user2,var_user3
```
...
**構文**
```
qgetuser2 num,var_user4,var_user5,var_user6
```
