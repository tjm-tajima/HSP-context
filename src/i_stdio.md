...
| 命令 | 概要 |
|---|---|
| [getkey](#getkey) | キー入力チェック |
| [mouse](#mouse) | マウスカーソル座標設定 |
| [randomize](#randomize) | 乱数発生の初期化 |
| [stick](#stick) | キー入力情報取得 |
| [logmes](#logmes) | デバッグメッセージ送信 |
| [assert](#assert) | デバッグウィンドウ表示 |
| [mcall](#mcall) | メソッドの呼び出し |
| [setease](#setease) | イージング関数の計算式を設定 |
| [sortval](#sortval) | 配列変数を数値でソート |
| [sortstr](#sortstr) | 配列変数を文字列でソート |
| [sortnote](#sortnote) | メモリノート文字列をソート |
| [sortget](#sortget) | ソート元のインデックスを取得 |
...
**関連**: #usecom, newcom, delcom, querycom, comres, %port-, Let
...
**関連**: sortstr, sortval, sortnote, %port-, Let
