...
- **URL**: http://hsp.tv/
- **対応環境**: Win
- **備考**: hsptv.asをインクルードすること。 / HSPTV対応プログラムの制限などに関してはhsptv_api.txtを参照のこと。

## 命令一覧

| 命令 | 概要 |
|---|---|
| [hsptv_up](#hsptv_up) | HSPTVデータ更新 |
| [hsptv_getrank](#hsptv_getrank) | HSPTVデータ取得 |
