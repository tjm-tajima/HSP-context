...
- **対応環境**: Win
- **動作条件**: Windows+OpenGL3.1以降/DirectX9システム上で動作します。
...
| 命令 | 概要 |
|---|---|
| [gpreset](#gpreset) | HGIMG4の初期化 |
| [gpdraw](#gpdraw) | シーン内の全オブジェクトを描画する |
| [gpusescene](#gpusescene) | シーンの切り替え |
| [gpsetprm](#gpsetprm) | オブジェクトのコアパラメーター設定 |
| [gpgetprm](#gpgetprm) | オブジェクトのコアパラメーター取得 |
| [gppostefx](#gppostefx) | ポストエフェクト生成 |
| [gpuselight](#gpuselight) | ライトオブジェクトの登録 |
| [gpusecamera](#gpusecamera) | カメラオブジェクトの切り替え |
| [gpmatprm](#gpmatprm) | マテリアルのパラメーター設定 |
| [gpmatstate](#gpmatstate) | マテリアルのステート設定 |
| [gpviewport](#gpviewport) | ビューポート設定 |
| [setobjname](#setobjname) | オブジェクトのノード名を設定する |
| [getobjname](#getobjname) | オブジェクトのノード名を取得する |
| [gpcolormat](#gpcolormat) | カラーマテリアルの生成 |
| [gptexmat](#gptexmat) | テクスチャマテリアルの生成 |
| [gpscrmat](#gpscrmat) | オフスクリーンテクスチャマテリアルの生成 |
| [gpusermat](#gpusermat) | カスタムマテリアルの生成 |
| [gpclone](#gpclone) | ノードを複製 |
| [gpnull](#gpnull) | ヌルノードを生成 |
| [gpload](#gpload) | 3Dモデルノードを生成 |
| [gpplate](#gpplate) | 板ノードを生成 |
| [gpfloor](#gpfloor) | 床ノードを生成 |
| [gpbox](#gpbox) | 箱ノードを生成 |
| [gpspr](#gpspr) | 2Dスプライトノード生成 |
| [gplight](#gplight) | ライトノードを設定 |
| [gpcamera](#gpcamera) | カメラノードを設定 |
| [gplookat](#gplookat) | 指定座標に向けてノードを回転 |
| [gppbind](#gppbind) | ノードに標準的な物理特性を設定 |
| [getwork2](#getwork2) | ノードワーク値2を取得 |
| [getwork2i](#getwork2i) | ノードワーク値2を取得(整数値) |
| [selquat](#selquat) | オブジェク回転情報をMOC情報に設定 |
| [selwork2](#selwork2) | オブジェクトワーク2をMOC情報に設定 |
| [setwork2](#setwork2) | work2グループ情報を設定 |
| [addwork2](#addwork2) | work2グループ情報を加算 |
| [gpcnvaxis](#gpcnvaxis) | 3D座標の変換を行なう |
| [gppset](#gppset) | ノードの物理パラメーターを設定 |
| [gpobjpool](#gpobjpool) | オブジェクトID生成の設定 |
| [gppapply](#gppapply) | ノードに物理的な力を適用する |
| [gpmatprm1](#gpmatprm1) | マテリアルのパラメーター設定(2) |
| [gpmatprm4](#gpmatprm4) | マテリアルのパラメーター設定(3) |
| [setalpha](#setalpha) | オブジェクトの透明度(α値)設定 |
| [gpgetlog](#gpgetlog) | HGIMG4エラーログを取得 |
| [gpaddanim](#gpaddanim) | アニメーションクリップを追加 |
| [gpact](#gpact) | アニメーションクリップを再生/停止 |
| [gpgetanim](#gpgetanim) | アニメーションクリップ設定を取得 |
| [gpsetanim](#gpsetanim) | アニメーションクリップ設定を更新 |
| [gpmatprm16](#gpmatprm16) | マテリアルのパラメーター設定(マトリクス) |
| [gpmatprmt](#gpmatprmt) | マテリアルのパラメーター設定(テクスチャ) |
| [gpusershader](#gpusershader) | ユーザーシェーダーの指定 |
| [gpgetmat](#gpgetmat) | マテリアルIDの取得 |
| [setquat](#setquat) | quatグループ情報を設定 |
| [getquat](#getquat) | quatグループ情報を取得 |
| [event_suicide](#event_suicide) | オブジェクト破棄イベントを追加 |
| [gpsetprmon](#gpsetprmon) | オブジェクトのコアパラメーター設定(ビット追加) |
| [gpsetprmoff](#gpsetprmoff) | オブジェクトのコアパラメーター設定(ビット削除) |
| [setangy](#setangy) | angグループ情報を設定 |
| [setangz](#setangz) | angグループ情報を設定 |
| [event_angy](#event_angy) | angグループ変化イベントを追加 |
| [event_angz](#event_angz) | angグループ変化イベントを追加 |
| [event_setangy](#event_setangy) | angグループ設定イベントを追加 |
| [event_setangz](#event_setangz) | angグループ設定イベントを追加 |
| [gpresetlight](#gpresetlight) | カレントライトの初期化 |
| [setobjlight](#setobjlight) | オブジェクトにカレントライトを設定 |
| [gppcontact](#gppcontact) | オブジェクトの物理衝突情報を作成する |
| [gppinfo](#gppinfo) | オブジェクトの物理衝突情報を取得する |
| [gppraytest](#gppraytest) | ベクトル上の物理衝突情報を取得する |
| [event_fade](#event_fade) | フェード設定イベントを追加 |
| [gpmesh](#gpmesh) | 3Dメッシューノードを生成 |
| [gpmeshclear](#gpmeshclear) | カスタム3Dメッシュを初期化 |
| [gpmeshadd](#gpmeshadd) | カスタム3Dメッシュに頂点情報を追加 |
| [gpmeshpolygon](#gpmeshpolygon) | カスタム3Dメッシュに面情報を追加 |
| [gpnodeinfo](#gpnodeinfo) | 3Dモデルの階層情報を取得する |
...
**関連**: gpgetprm, gpsetprmon, gpsetprmoff
...
**関連**: gpresetlight, gplight, gpusecamera, setobjlight
...
**関連**: gpcolormat, gpusermat, gpscrmat
...
**関連**: gpmatprm, gpcolormat, gptexmat, gpusershader, gpscrmat
...
**関連**: gpresetlight, gpuselight, gpnull
...
**関連**: gpmat, gpmatprm, gpmatprm4, gpmatprm16
...
**関連**: gpmat, gpmatprm, gpmatprm1, gpmatprm16
...
**関連**: gpaddanim, gpgetanim, gpsetanim
...
**関連**: gpmatprm, gpmatprm1, gpmatprm4
...
**関連**: buffer, gpmatprm, gpmatprm1, gpmatprm4, gpmatprm16
...
**関連**: gpgetprm, gpsetprm, gpsetprmoff
...
**関連**: gpgetprm, gpsetprm, gpsetprmon
...
**構文**
```
event_angy id,frame,x1,y1,z1,sw
```
...
**関連**: event_ang, event_angz, event_angr
...
**構文**
```
event_angz id,frame,x1,y1,z1,sw
```
...
**関連**: event_ang, event_angy, event_angr
...
**構文**
```
event_setangy id,x1,y1,z1,x2,y2,z2
```
...
**関連**: event_setang, event_setangz, event_setangr
...
**構文**
```
event_setangz id,x1,y1,z1,x2,y2,z2
```
...
**関連**: event_setang, event_setangy, event_setangr
...
**関連**: gppbind, gppinfo, getcoli, setcoli, gppraytest
...
**関連**: gppcontact, getcoli, getwork, getwork2
...
**関連**: gpmeshclear, gpmeshpolygon, gpmeshadd
...
**関連**: gpmesh, gpmeshpolygon, gpmeshadd
...
**関連**: gpmeshclear, gpmeshpolygon, gpmesh
...
**関連**: gpmeshclear, gpmeshadd, gpmesh
